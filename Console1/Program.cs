...
<message role=""user"">{{this[0].Content}}</message>
<message role=""assistant"">{{this[1].Content}}</message>
{{/each}}
...
string chatTemplate = @"<message role=""system"">You are a helpful assistant.</message>
{{#each history}}
<message role=""{{this.Role}}"">{{this.Content}}</message>
{{/each}}
<message role=""user"">{{request}}</message>";
